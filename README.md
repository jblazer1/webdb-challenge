...
RDBMS is the software used to manage a database and SQL is the language used to interact with the RDBMS.

1. Why do tables need a `primary key`?

It is a special column used to identify all records in a database table. It must be unique for each record.
...
another table, sometimes referred to as a bridge table
